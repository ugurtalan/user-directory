...
export default function UsersPage() {
  ...
  return (
   ...
   <div className="flex flex-col justify-center items-center" >
    ...
    {/*Favoriler divi*/}
      <div className="overflow-auto relative flex flex-col item-center mt-10 ml-5 border-8 border-r-4 rounded-md bg-slate-300 h-1/2 w-full max-w-48">
      ...
      <div className="w-full h-1 bg-black mt-2 opacity-70"></div>
        ...
        <button className="bg-red-900 text-yellow-50  p-3 pb-2 pt-2 rounded-t-lg absolute bottom-0 w-full" onClick={()=>users.forEach((user : User)=>{
        removeFavorite(user.id);
       })}>Temizle</button>
      </div>
